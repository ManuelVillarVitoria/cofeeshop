        ...
        try
            {
                ...
                $dbh = new \PDO("mysql:host=mysql-manuel34.alwaysdata.net;dbname=".$this->container->getParameter('database_name'),$this->container->getParameter('database_user'),$this->container->getParameter('database_password'),array(\PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES 'utf8'"));
                $num_dia = date('w');
                $logger->info($num_dia);
